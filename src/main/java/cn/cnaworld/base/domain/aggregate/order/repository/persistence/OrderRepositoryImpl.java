package cn.cnaworld.base.domain.aggregate.order.repository.persistence;

import cn.cnaworld.base.domain.aggregate.order.model.entity.Goods;
import cn.cnaworld.base.domain.aggregate.order.model.root.Order;
import cn.cnaworld.base.domain.aggregate.order.repository.facade.OrderRepository;
import cn.cnaworld.base.domain.aggregate.order.repository.orm.IGoodsPoService;
import cn.cnaworld.base.domain.aggregate.order.repository.orm.IOrderPoService;
import cn.cnaworld.base.domain.aggregate.order.repository.orm.po.GoodsPo;
import cn.cnaworld.base.domain.aggregate.order.repository.orm.po.OrderPo;
